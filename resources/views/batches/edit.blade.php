                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date"
                                                   ...
                                                   value="{{ old("valid_from", $batch->valid_from) }}"
                                            >
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date"
                                                   ...
                                                   value="{{ old("valid_till",$batch->valid_till) }}"
                                            >
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input 
                                                ...
                                                value="{{ old("expected_arrival_time",$batch->expected_arrival_time) }}"
                                            >
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input 
                                                ...
                                                value="{{ old("expected_harvest_time",$batch->expected_harvest_time) }}"
                                            >
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input 
                                                ...
                                                value="{{ old("expected_delivery_time",$batch->expected_delivery_time) }}"
                                            >
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input 
                                                ...
                                                value="{{ old("expected_departure_time",$batch->expected_departure_time) }}"
                                            >
